...
Defaults = (Meta(name="viewport", content="width=device-width"),
            ...
            Meta(property="og:description" ,content="PineSAT is offical site of the OpenSAT project, a free and open-source SAT question bank. Dive into a massive pool of SAT practice problems, constantly growing thanks to a dedicated community of contributors."),
...
,
            ...
            NotStr('<script defer src="https://cloud.umami.is/script.js" data-website-id="d6214ed5-d28d-4bbc-bbdf-e9da88f38f6b"></script>'),
...
def Navbar():
    return Div(
        ...
        menu_button(),
        cls="navbar bg-warning shadow-xl text-warning-content bg_pattern_yellow"
    )
...
def get(request, session):
    ...
    first_hero = Div(
        ...
        cls="hero bg-warning min-h-screen mb-0 rounded-b-3xl bg_pattern_yellow"
    )
